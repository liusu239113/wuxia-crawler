...
data class CombatState(
    ...
    var enemySubtitle: String = "",
    var enemyHonorTitle: String = "",
    var enemyHonorColor: Long = 0xFFFFD700,
    ...
    var playerStartHp: Int = 0,
    var expReward: Int = 0, var goldReward: Int = 0, var hasDrop: Boolean = false,
    var tournamentRank: Int = 0,
    var tournamentOldRank: Int = 0,
    var tournamentPromotionBattle: Boolean = false,
